    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_custom_interfaces.msg.HardwareStatus')
            logger.debug(
...
class HardwareStatus(metaclass=Metaclass_HardwareStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.are_motors_ok = kwargs.get('are_motors_ok', bool())
    ...
    def __eq__(self, other):
        ...
        if self.temperature != other.temperature:
            return False
        if self.are_motors_ok != other.are_motors_ok:
            return False
    ...
    @builtins.property
    def are_motors_ok(self):
        """Message field 'are_motors_ok'."""
        return self._are_motors_ok

    @are_motors_ok.setter
    def are_motors_ok(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'are_motors_ok' field must be of type 'bool'"
        self._are_motors_ok = value
