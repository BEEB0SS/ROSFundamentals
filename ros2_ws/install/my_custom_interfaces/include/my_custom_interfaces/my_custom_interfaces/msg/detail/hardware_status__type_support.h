...
#ifndef MY_CUSTOM_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__TYPE_SUPPORT_H_
#define MY_CUSTOM_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__TYPE_SUPPORT_H_
...
#endif  // MY_CUSTOM_INTERFACES__MSG__DETAIL__HARDWARE_STATUS__TYPE_SUPPORT_H_
